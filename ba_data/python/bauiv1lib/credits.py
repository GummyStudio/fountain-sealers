...
class CreditsWindow(bui.MainWindow):
    ...
    def __init__(
        ...
        credits_text = (
            bui.Lstr(resource=f'{self._r}.creatorsText').evaluate()
            + '\n'
            + '\n'
            + bui.Lstr(resource=f'{self._r}.modelsText').evaluate()
            + '\n'
            + '\n'
            + bui.Lstr(resource=f'{self._r}.specialThanksBombSquadText').evaluate()
            + '\n'
            + '\n'
            + bui.Lstr(resource=f'{self._r}.deltaruneText').evaluate()
            + '\n'
            + '\n'
            + bui.Lstr(resource=f'{self._r}.noProfitText').evaluate()
            + '\n'
            + '\n'
            + '\n'
            + bui.Lstr(resource=f'{self._r}.waitingText').evaluate()
        )
        ...
        voffs = 0
        for line in lines:
            x = 50 if uiscale is bui.UIScale.SMALL else 20
            bui.textwidget(
                parent=container,
                padding=4,
                ...
                flatness=1.0,
                size=(0, 0),
                position=(x, self._sub_height - 20 + voffs),
                h_align='left',
                v_align='top',
